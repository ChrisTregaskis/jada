...
router.put('/preferences/:userId', checkAuth, setPreferencesController.set_user_preferences);
router.put('/preferences/keyWords/:userId', checkAuth, deletePreferencesController.delete_user_preferences);
